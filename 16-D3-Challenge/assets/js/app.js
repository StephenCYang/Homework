...
function dataMap(stateData){
    stateData.map(function (d) {
        d.obesity = +d.obesity;
        d.poverty = +d.poverty;
        d.age = +d.age;
        d.income = +d.income;
...
x.domain([8, d3.max(stateData, d => d.poverty)])
svg.select(".myXaxis")
  .transition()
  .duration(2000)
  .attr("opacity", "1")
...
svg.selectAll()
    ...
    .on("mouseover", function(d){return tooltip
        // okay here, I couldn't figure out how to get the state name in here. Also I went with
        // .html because I couldn't get line breaks working.
        // Oh! And d3-tip.js had it's own issues, that I didn't want to debug. :-/
        .html("Poverty: " + d.poverty +"%<br>" + "Obesity: " + d.obesity +"%")
        .style("fill", "black")    //doesn't do anything for .html
        .style("stroke", "white")  //doesn't do anything for .html
